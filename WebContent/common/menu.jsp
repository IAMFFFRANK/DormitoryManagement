<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <style>
				...
				<div class="min">					
					<div class="tc_login">											
						<div class="login_register">
							<form method="POST" name="form_login" target="_top" action="/ssm_dorm_manage/login/toLogin.do">
								<div align="center">
		...
		<!--nav start-->
		<div class="nav_menu">
			<a href="/ssm_dorm_manage/login/index.do" class="logo fl"><img src="" /><span style="font-size: 50px">校园门户网站</span></a>
			<div class="nav_list fr">
				<ul id="nav" class="nav clearfix">
					...
					<li class="nLi">
						<h3><a href="/ssm_dorm_manage/xkzy/findByObj2.do">学科资源</a></h3>
					</li>
			</div>
			<div class="clear"></div>
		</div>