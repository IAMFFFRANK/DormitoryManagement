...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/ssm_dorm_manage/manage/exUpdate.do" enctype="multipart/form-data"> 
    <input type="hidden" name="id" value="${obj.id}">  
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="nickName" value="${obj.nickName }" data-validate="required:请输入真实名" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="teacherId" value="${obj.teacherId }" data-validate="required:请输入教工号" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
