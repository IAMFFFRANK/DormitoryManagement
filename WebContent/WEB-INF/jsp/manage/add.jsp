...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/ssm_dorm_manage/manage/exAdd.do" enctype="multipart/form-data">
     <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="teacherId" value="" data-validate="required:请输入教工号" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
