    ...
    <form method="post" class="form-x" action="/ssm_dorm_manage/student/exAdd.do" enctype="multipart/form-data">
     <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="nickName" value="" data-validate="required:请输入真实名" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="studentId" value="" data-validate="required:请输入学号" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="jiguan" value="" data-validate="required:请输入籍贯" />         
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
