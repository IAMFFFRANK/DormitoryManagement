...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search">
        <li>
           <a class="button border-main icon-plus-square-o" href="${ctx }/student/add.do">添加学生</a> 
        </li>
         <li>
      ...
      <tr>
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="/ssm_dorm_manage/student/update.do?id=${data.id}"><span class="icon-edit"></span>修改</a> 
