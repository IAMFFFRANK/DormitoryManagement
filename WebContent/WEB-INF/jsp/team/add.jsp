...
<div class="panel admin-panel margin-top">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>班级添加</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="/ssm_dorm_manage/team/exAdd.do" enctype="multipart/form-data">
     <div class="form-group">
          ...
          <div class="field">
            <select name="majorId" class="input w50">
              <option value="">请选择专业</option>
               <c:forEach items="${majorList}" var="data" varStatus="l">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="name"  data-validate="required:请输入班级名称" />         
          <div class="tips"></div>
        </div>
      </div> 
