...
<div class="leftnav">
  ...
  <ul style="display:block">
		...
		<li><a href="/ssm_dorm_manage/manage/myBuilding.do" target="right"><span class="icon-caret-right"></span>我管理的宿舍楼</a></li>
		<li><a href="/ssm_dorm_manage/manage/myDomitory.do" target="right"><span class="icon-caret-right"></span>我管理的宿舍</a></li>
		<li><a href="/ssm_dorm_manage/manage/myBed.do" target="right"><span class="icon-caret-right"></span>我管理的床位</a></li>
		<li><a href="/ssm_dorm_manage/manage/ruzhu.do" target="right"><span class="icon-caret-right"></span>入住登记</a></li>
	    <li><a href="/ssm_dorm_manage/manage/tuifang.do" target="right"><span class="icon-caret-right"></span>退房管理</a></li>
        <li><a href="/ssm_dorm_manage/manage/personInfo.do" target="right"><span class="icon-caret-right"></span>个人信息修改</a></li>
