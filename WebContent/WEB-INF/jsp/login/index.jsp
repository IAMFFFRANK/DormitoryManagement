...
<title>校园门户网站首页</title>
		<link rel="stylesheet" type="text/css" href="/ssm_dorm_manage/resource/css/style.css" />
		<link rel="stylesheet" type="text/css" href="/ssm_dorm_manage/resource/css/popup.css"/>
		<style type="text/css">
...
#focus .next{right:0;background-position:right top;}
			...
			<script src="/ssm_dorm_manage/resource/js/jquery-1.11.0.min.js" type="text/javascript"></script>
...
<!-- model.addAttribute("phs", phs);
		...
		<%-- 	<li class="nLi"></li>
					<li class="nLi">
						<h3><a href="/ssm_dorm_manage/news/findByObj2.do">新闻快讯</a></h3>
					</li>
					<li class="nLi">
						<h3><a href="/ssm_dorm_manage/notice/findByObj2.do">通知公告</a></h3>
					</li>
					<li class="nLi">
						<h3><a href="/ssm_dorm_manage/xl/findByObj2.do">校历</a></h3>
					</li>
					<li class="nLi">
						<h3><a href="/ssm_dorm_manage/schoolJob/findByObj2.do">求职招聘</a></h3> --%>
		...
		<div class="notice_wrap">
			<div class="notice">
				...
				<a href="/ssm_dorm_manage/notice/findByObj2.do" class="more fr">更多+</a>
				<div class="clear"></div>
			</div>
		</div>
		<!--content start-->
		<div class="content">
			...
			<div class="box1">
				<div class="fl">
					<div class="news">
						<div class="b_title">
							<h3>新闻快讯</h3>
							<a href="/ssm_dorm_manage/news/findByObj2.do" class="more">更多+</a>
						</div>
						<div class="b_wrap">
							<div class="fl n_list">
								<ul>
				...
				<div class="fl">
					<div class="news" style="margin-left: 30px">
						<div class="b_title">
							<h3>校园招聘</h3>
							<a href="/ssm_dorm_manage/schoolJob/findByObj2.do" class="more">更多+</a>
						</div>
						<div class="b_wrap">
							<div class="fl n_list">
								<ul>
			...
			<div class="fl">
					<div class="news" style="height: 250px;margin-top: 0px">
						<div class="b_title">
							<h3>通知公告</h3>
							<a href="/ssm_dorm_manage/notice/findByObj2.do" class="more">更多+</a>
						</div>
						<div class="b_wrap">
							<div class="fl n_list">
								<ul>
				...
				<div class="exam fr">
					<div class="b_title">
						<h3>校历</h3>
						<a href="/ssm_dorm_manage/xl/findByObj2.do" class="more">更多+</a>
					</div>
					<div class="b_wrap">
						<div class="n_list">
							<ul>
		...
		<script src="/ssm_dorm_manage/resource/js/jquery.SuperSlide.2.1.js" type="text/javascript"></script>
		<script src="/ssm_dorm_manage/resource/js/common.js"></script>
		<script src="/ssm_dorm_manage/resource/js/jquery.slides.min..js"></script>
		<script type="text/javascript">
