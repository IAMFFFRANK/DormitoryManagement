...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/ssm_dorm_manage/major/exUpdate.do" enctype="multipart/form-data"> 
          ...
          <div class="field">
            <select name="collegeId" class="input w50">
              <option value="">请选择类型</option>
               <c:forEach items="${collegeList}" var="data" varStatus="l">
               		<c:if test="${data.id == obj.collegeId}">
