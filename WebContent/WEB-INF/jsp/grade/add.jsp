...
<div class="panel admin-panel margin-top">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>年级添加</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="/ssm_dorm_manage/grade/exAdd.do"> 
      <div class="form-group">
        <div class="label">
          <label>年级名称：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" name="name"  data-validate="required:请输入年级" />         
          <div class="tips"></div>
        </div>
      </div> 
     <div class="form-group">
